      ...
      <ScrollView contentContainerStyle={{ height: "100%" }}>
        <View className="w-full justify-center min-h-[85vh] items-center px-4">
          ...
          <View className="relative mt-5">
            ...
            <Image source={images.path} className="w-[136px] h-[15px] absolute -bottom-2.5 -right-8"
              resizeMode="contain"
            />
          </View>

          <Text className="text-sm font-pregular text-gray-100 mt-5 text-center">
            Where creativity meets innovation: embark on journey limitless exploration with Aora.
          </Text>
          <CustomButton
