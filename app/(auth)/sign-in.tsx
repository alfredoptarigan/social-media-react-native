    ...
    <SafeAreaView className="bg-primary h-full ">
      <ScrollView>
        <View className="w-full justify-center min-h-[80vh] px-4 my-6">
          ...
          <Text className="text-2xl text-white text-bold mt-10 font-psemibold"> Login to Aora</Text>
          <FormField
            title="Email"
            value={form.email}
          ...
          <View className="justify-center pt-5 flex-row gap-2">
            ...
            <Link href="/sign-up" className="text-secondary text-lg text-bold"> Sign Up </Link>
          </View>
        </View>
      </ScrollView>
    </SafeAreaView>
